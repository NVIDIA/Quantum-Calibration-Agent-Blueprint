---
title: "Quantum Calibration Agent — Tutorial"
description: ""
---
...
> **vLLM requirement:** The server must be launched with `--enable-auto-tool-choice --tool-call-parser qwen3_coder` for tool calling to work. See [vLLM setup guide](/vllm-local-model-setup) for full details.
