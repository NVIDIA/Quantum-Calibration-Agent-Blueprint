...
<Frame caption="The QCA command-line interface showing the welcome banner.">
  <img src="../_static/images/usage/cli-banner.png" alt="The QCA command-line interface showing the welcome banner." />
</Frame>
